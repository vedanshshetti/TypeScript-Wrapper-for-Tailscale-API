...
import { APIKey, GetDevicePostureAttributesReturnType, GetDeviceReturnType, IPAddress, ListDeviceRoutesReturnType, ListTailnetDevicesReturnType, SetCustomDevicePostureAttributesBody, SetDeviceRoutesBody, SetDeviceRoutesReturnType, UpdateCustomDevicePostureAttributesBody } from "../types";
...
const createDevicesInterface = (apiKey: APIKey, deviceID: string) => {
    return {
         ...
         */
        listTailnetDevices: (tailnet: string): Promise<ListTailnetDevicesReturnType> => createDeviceLister(apiKey, tailnet),
        /**
         * Gets the device information for given device ID.
         * @returns {Promise<GetDeviceReturnType>} An object of device data.
         */
        getDevice: (): Promise<GetDeviceReturnType> => createDeviceRetriever(apiKey, deviceID),
        /**
         ...
         */
        batchUpdateCustomDevicePostureAttributes: (body: UpdateCustomDevicePostureAttributesBody): Promise<void> => createCustomDeviceBatchPostureAttributesUpdater(apiKey, deviceID, body),
        /**
         ...
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        expireDeviceKey: (): Promise<void> => createDeviceKeyExpiry(apiKey, deviceID),
        /**
         ...
         */
        listDeviceRoutes: (): Promise<ListDeviceRoutesReturnType> => createDeviceRouteLister(apiKey, deviceID),
        /**
         ...
         */
        setDeviceRoutes: (body: SetDeviceRoutesBody): Promise<SetDeviceRoutesReturnType> => createDeviceRouteSetter(apiKey, deviceID, body),
        /**
         * Changes the authorization for a device.
         * @param authorized Boolean value: true for authorizing device, false for unauthorizing.
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        authorizeDevice: (authorized: boolean): Promise<void> => createDeviceAuthorizer(apiKey, deviceID, authorized),
        /**
         * Sets / Changes the device name for device with given deviceID.
         * @param name The new name.
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        setDeviceName: (name: string): Promise<void> => createDeviceNameSetter(apiKey, deviceID, name),
        /**
         * Sets / Changes the device tags for device with given deviceID.
         * @param tags The new tags.
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        setDeviceTags: (tags: string[]): Promise<void> => createDeviceTagsSetter(apiKey, deviceID, tags),
        /**
         * Updates the key expiry for device with given deviceID.
         * @param canKeyExpire Whether key should be able to expire.
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        updateDeviceKey: (canKeyExpire: boolean): Promise<void> => createDeviceKeyUpdater(apiKey, deviceID, canKeyExpire),
        /**
         ...
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        setDeviceIPV4Address: (ipv4: IPAddress): Promise<void> => createDeviceIPV4AddrSetter(apiKey, deviceID, ipv4),
        /**
         ...
         */
        getDevicePostureAttributes: (): Promise<GetDevicePostureAttributesReturnType> => createDevicePostureAttributesRetriever(apiKey, deviceID),
        /**
         ...
         */
        setCustomDevicePostureAttributes: (attribute: SetCustomDevicePostureAttributesBody): Promise<GetDevicePostureAttributesReturnType> => createCustomDevicePostureAttributesSetter(apiKey, deviceID, attribute),
        /**
         ...
         * @returns {Promise<void>} Void if successful, else throws an error.
         */
        deleteCustomDevicePostureAttributes: (attributeKey: string): Promise<void> => createCustomDevicePostureAttributesDeletion(apiKey, deviceID, attributeKey)
    };
};
